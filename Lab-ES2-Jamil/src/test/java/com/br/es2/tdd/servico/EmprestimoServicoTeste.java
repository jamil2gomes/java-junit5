...
public class EmprestimoServicoTeste {
	...
	public void setUp() {
		...
		usuario1 = UsuarioBuilder.umUsuario()
								 .comMatricula("123")
								 .comNome("Luana")
								 .constroi();
		
		usuario2 = UsuarioBuilder.umUsuario()
								 .comMatricula("456")
								 .comNome("Jamil")
								 .constroi();

		livro1 = LivroBuilder.umLivro()
							 .comAutor("J.k Rowling")
							 .comTitulo("Harry Potter 1")
							 .constroi();

		livro2 = LivroBuilder.umLivro()
							 .comAutor("J.k Rowling")
							 .comTitulo("Harry Potter 2")
							 .ehReservado(true)
							 .constroi();
		
		livro3 = LivroBuilder.umLivro()
							 .comAutor("J.k Rowling")
							 .comTitulo("Harry Potter 3")
							 .constroi();
	...
	public void emprestimoEmLivroReservado() 
	{
		RuntimeException exception = assertThrows(RuntimeException.class,
				() -> emprestimo.emprestar(usuario1, livro2),
	...
	public void testaDevolucaoAntesDaDataPrevista() {
		...
		assertAll(
					()->assertTrue(dataDevolucao.isBefore(dataPrevista)),
	...
	public void testaDevolucaoNaDataPrevista() {
		...
		LocalDate dataPrevista = emprestimo.getEmprestimo().getDataPrevista();
		assertAll(
					()->assertTrue(dataDevolucao.isEqual(dataPrevista)),
					()->assertEquals(5.0, valor, 0.00001)
				);
	...
	public void testaDevolucaoUmDiaDaDataPrevista() {
		...
		LocalDate dataPrevista = emprestimo.getEmprestimo().getDataPrevista();
		assertAll(
					()->assertEquals(1, ChronoUnit.DAYS.between(dataPrevista, dataDevolucao)),
	...
	public void testaDevolucaoTrintaDiasDepoisDaDataPrevista() {
		...
		LocalDate dataPrevista = emprestimo.getEmprestimo().getDataPrevista();
		assertAll(
					()->assertEquals(30, ChronoUnit.DAYS.between(dataPrevista, dataDevolucao)),
